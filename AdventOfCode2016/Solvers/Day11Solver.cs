...
namespace AdventOfCode2016.Solvers
{
    public class Day11Solver
    {
        ...
        {
            ParsedComponentsByFloor = new Dictionary<int, HashSet<Day11Component>>();
        ...
        private int FindCostOfBestMove(int currentFloor, Dictionary<int, HashSet<Day11Component>> currentState)
        {
        ...
        private bool AnyFloorIsInvalid(Dictionary<int, HashSet<Day11Component>> currentState)
        {
        ...
        private int TryAllMovesToFindBest(int currentFloor, Dictionary<int, HashSet<Day11Component>> currentState)
        {
        ...
        private string GetStateIdentifier(Dictionary<int, HashSet<Day11Component>> currentState)
        {
        ...
        private bool AllComponentsAreOnFourthFloor(Dictionary<int, HashSet<Day11Component>> currentState)
        {
        ...
        private int GetCostOfMovingItemUp(int currentFloor, Dictionary<int, HashSet<Day11Component>> currentState, Day11Component item)
        {
        ...
        private int GetCostOfMovingItemDown(int currentFloor, Dictionary<int, HashSet<Day11Component>> currentState, Day11Component item)
        {
        ...
        private int CostOfMovingItemToFloor(int currentFloor, int nextFloor, Dictionary<int, HashSet<Day11Component>> currentState, Day11Component item)
        {
        ...
        private int GetCostOfMovingItemPairUp(int currentFloor, Dictionary<int, HashSet<Day11Component>> currentState, Day11Component item, Day11Component compatibleItem)
        {
            if (currentFloor >= 3) return IntegerPaddedMaxValue;
            var nextFloor = currentFloor + 1;
        ...
        private int GetCostOfMovingItemPairDown(int currentFloor, Dictionary<int, HashSet<Day11Component>> currentState, Day11Component item, Day11Component compatibleItem)
        {
            if (currentFloor <= 0) return IntegerPaddedMaxValue;
            var nextFloor = currentFloor - 1;
        ...
        private int CostOfMovingItemPairToFloor(int currentFloor, int nextFloor, Dictionary<int, HashSet<Day11Component>> currentState, Day11Component item,
            Day11Component compatibleItem)
        {
            currentState[currentFloor].Remove(item);
        ...
        private Dictionary<int, HashSet<Day11Component>> DeepCopy(Dictionary<int, HashSet<Day11Component>> componentsByFloor)
        {
            var copiedComponentsByFloor = new Dictionary<int, HashSet<Day11Component>>();
            foreach (var key in componentsByFloor.Keys)
            {
                copiedComponentsByFloor[key] = new HashSet<Day11Component>(componentsByFloor[key].AsEnumerable());
            }
        ...
        public Dictionary<int, HashSet<Day11Component>> ParsedComponentsByFloor { get; set; }
    }
}